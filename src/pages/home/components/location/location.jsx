  ...
  return (
    <section className="location">
      ...
      <div className="cardLocation">
        <h3>Sucursal Antiguo camino al Mezquital</h3>
          ...
          <div>
            ...
            <span className="location__item-icon">
              <a
                ...
                href="https://www.google.com/maps?ll=25.756298,-100.248488&z=17&t=m&hl=es&gl=MX&mapclient=embed&q=Antiguo+Camino+Al+Mezquital+2204+Vicente+Guerrero+2do+Sector+66437+San+Nicol%C3%A1s+de+los+Garza,+N.L."
              >
                Antiguo Camino al Mezquital 2204
              </a>
            </span>
          </div>
          <div>
            <img
              ...
              className="location__icon"
            />
            <span className="location__item-icon">8:00 AM a 3:00 pm</span>
          </div>
        </div>
        <iframe
